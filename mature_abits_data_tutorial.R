### Базова обробка та аналіз даних про вступну кампанію 2019 ###

## У цьому аналізі ми порівняємо абітурієнтів, які вступали до ЗВО на денну форму на 1 курс 
## одразу після школи та тих, які завершили середню освіту раніше 2019 року.

## Цей скрипт є прикладом експлораторного аналізу - ми досліджуватимемо дані за допомогою описових статистик та графіків.
